...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "서울교통공사 AX 홈페이지 | 시민 중심 리뉴얼" },
      { property: "og:description", content: "찾는 홈페이지에서 해결해주는 홈페이지로. AI Assistant 기반 시민 중심 공공서비스 프로토타입." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "서울교통공사 AX 홈페이지 | 시민 중심 리뉴얼" },
      { name: "twitter:description", content: "찾는 홈페이지에서 해결해주는 홈페이지로. AI Assistant 기반 시민 중심 공공서비스 프로토타입." },
